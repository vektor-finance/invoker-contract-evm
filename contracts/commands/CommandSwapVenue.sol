...
contract CSwapVenue is Storage {
    using SafeERC20 for IERC20;

    IWETH public immutable WNATIVE;

    bytes32 public constant CSWAP_VENUE_UNISWAP = keccak256("UNISWAP_ROUTER");
    ...
    constructor(address _wnative, address _router) {
        ...
        writeAddress(CSWAP_VENUE_UNISWAP, _router);
    }

    function init(address _router) external payable {
        writeAddress(CSWAP_VENUE_UNISWAP, _router);
    }
    ...
    **/
    function swapUniswapIn(
        ...
        IUniswapV2Router02 UNISWAP_ROUTER = IUniswapV2Router02(readAddress(CSWAP_VENUE_UNISWAP));
